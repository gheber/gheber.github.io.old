...
docker run --name hermes_container --shm-size 1G \
       -v /mnt/hd:/hd -v /mnt/sdcard:/sdcard \
       --it --entrypoint /bin/bash 5239038d60f1
...
mpiexec -n 4 demo 32 4 0 ./hermes.conf 2>&1 | tee stdout.xt | grep "\[us\]"
...
#+begin_example
hermes@d69a3f7ab649:~$ mpiexec -n 4 ./source/build/bin/demo 32 4 0 \
...
hermes@d69a3f7ab649:~$ mpiexec -n 4 ./source/build/bin/demo 32 4 1 \
                         ./hermes.conf 2>&1 | tee stdout.xt | grep "\[us\]"
...
hermes@d69a3f7ab649:~$ mpiexec -n 4 ./source/build/bin/demo 32 4 2 \
                         ./hermes.conf 2>&1 | tee stdout.xt | grep "\[us\]"
...
hermes@991d97cb00f1:~/source/build$ LD_PRELAOD=libgotcha_stdio.so ./bin/demo2 \
  $((2048*1024*1024))
fwrite [us] : 872106 : ~2462 MB/s
fwrite+fclose [us] : 8557582 : ~250 MB/s
