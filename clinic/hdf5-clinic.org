...
* Clinic 2021-03-09
** Your questions (as of 9:00 a.m. Central Time today)
*** Question 1
#+begin_quote
...
- Size limit :: No, not in newer versions (1.8.x+) of HDF5. See [[https://portal.hdfgroup.org/pages/viewpage.action?pageId=48808714][What limits are
  there in HDF5?]]
- Performance :: It depends. (...on what you mean by /performance/)
  ...
  - There values are treated as atomic units, i.e., you will always write and
